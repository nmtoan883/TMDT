...
urlpatterns = [
    ...
    path('ecommerce/hotdeal-campaign/', views.ec_hotdeal_campaign_list, name='ec_hotdeal_campaign_list'),
    path('ecommerce/hotdeal-campaign/add/', views.ec_hotdeal_campaign_add, name='ec_hotdeal_campaign_add'),
    path('ecommerce/hotdeal-campaign/edit/<int:pk>/', views.ec_hotdeal_campaign_edit, name='ec_hotdeal_campaign_edit'),
    path('ecommerce/hotdeal-campaign/delete/<int:pk>/', views.ec_hotdeal_campaign_delete, name='ec_hotdeal_campaign_delete'),
